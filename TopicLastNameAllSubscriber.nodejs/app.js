...
var serviceBusService = azure.createServiceBusService("Endpoint=sb://[bus namespace].servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=[shared key]=");
